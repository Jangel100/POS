...
Public Class TransferenciaDormimundo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DCitySite.TransferenciaDormimundo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDENVIO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTransferenciaDormimundo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TransferenciaDormimundo = New TransferenciaDormimundo
        rpt.Site = Me.Site
        Return rpt
    End Function
