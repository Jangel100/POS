        ...
        if (result.isConfirmed) {
            ...
            $('#tblAbono tr').each(function (row, tr) {
                TableAbono[row] = {
                    ...
                    "Parcialidad": Number($(this).find("td").eq(15).html()) + 1,
                    "FechaPago": FechaPago,
                }
            });
