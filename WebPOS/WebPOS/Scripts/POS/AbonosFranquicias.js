...
function SearchPedidoF() {
    var folio = $("#folipedido").val();
    $.ajax({
        type: "POST",
        url: '/AbonosFranquicias/BuscapedidoF',
        data: "{ 'folio': '" + folio + "'}",
...
function AddAbonoF() {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                type: "POST",
                url: '/AbonosFranquicias/AddAbonoF',
                data: "{ 'Abono': '" + Data + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
$("#datalistcliente").on('input', function () {
    ...
    $.ajax({
        type: "POST",
        url: '/AbonosFranquicias/GetPeriodsF',
...
$("#ddlPeriodo").change(function () {
    ...
    var fecha = $("#ddlPeriodo option:selected").val();
    var val = $('#datalistcliente').val();
    var Idcliente = $('#datalistOptincli').find('option[value="' + val + '"]').data('code');
    //var Idcliente = $("#ddlClientes option:selected").val();
    $.ajax({
        type: "POST",
        url: '/AbonosFranquicias/GetDaysF',
...
$("#ddlDia").change(function () {
    ...
    var Idcliente = $('#datalistOptincli').find('option[value="' + val + '"]').data('code');
    //var Idcliente = $("#ddlClientes option:selected").val();
    var dia = $("#ddlDia option:selected").val();
    $.ajax({
        type: "POST",
        url: '/AbonosFranquicias/GetFoliosF',
...
$("#ddlFolio").change(function () {
    var fecha = $("#ddlPeriodo option:selected").val();
    var val = $('#datalistcliente').val();
    var Idcliente = $('#datalistOptincli').find('option[value="' + val + '"]').data('code');
    //var Idcliente = $("#ddlClientes option:selected").val();
    var dia = $("#ddlDia option:selected").val();
    var folio = $("#ddlFolio option:selected").val();
    $.ajax({
        type: "POST",
        url: '/AbonosFranquicias/BuscapedidoF',
...
function FormaPagoAbonos() {
    ...
    switch (formapago) {
        case "Terminal PROSA":    
            $("#seltarjeta").prop("disabled", false);
            $("#terminatarjeta").prop("disabled", false);
            break;
        case "American Express":
            $("#seltarjeta").prop("disabled", false);
            $("#terminatarjeta").prop("disabled", false);
        ...
        case "Terminal Banamex":
            ...
            break;
        case "Efectivo":
            $("#seltarjeta").prop("disabled", true);
            $("#terminatarjeta").prop("disabled", true);
            break;
        case "Deposito / Cheque":
            $("#seltarjeta").prop("disabled", true);
            $("#terminatarjeta").prop("disabled", true);
