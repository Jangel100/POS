...
{
    public class AbonosFranquiciasController : ApiController
    {
        private string connWEB;
        returnpago infopago = new returnpago();
        [System.Web.Http.Route("api/searchpedidoF")]
        public JsonResult<List<AddPay>> searchpedidoF(AddPay abonos)
        {
        ...
        [System.Web.Http.Route("api/AddPayF")]
        [System.Web.Http.HttpPost]
        public JsonResult<AddPay> AddPayF(AddPay Pago)
        {
        ...
        public bool realizaAbono(AddPay AddPago)
        {
            ...
            squery = " insert into VentasPagos (IDVenta,AdminStoreID,TipoVenta,FormaPago,TipoTarjeta,Monto,Fecha,StatusPago,NoCuenta,Prefijo,Folio,Afiliacion,FormaPago33,MetodoPago33,TipoComp33,UsoCFDI33,TipoRel33,CFDI_Rel33,CorreoCliente,CorreoUsuario,Parcialidad,FechaPago)" + Environment.NewLine;
            ...
            "','" + AddPago.CorreoCliente + "','" + AddPago.CorreoUsuario + "'," + AddPago.Parcialidad + ",'" + (!string.IsNullOrEmpty(AddPago.FechaPago) ? Convert.ToDateTime(AddPago.FechaPago).ToString("yyyy-MM-dd") : DateTime.Now.ToString("yyyy-MM-dd")) + "')" + Environment.NewLine;
        ...
        [System.Web.Http.Route("api/GetPeriodsF")]
        public JsonResult<List<ListPeriodo>> GetPeriodsF(string idcliente)
        {
        ...
        [System.Web.Http.Route("api/GetDaysF")]
        public JsonResult<List<ListDia>> GetDaysF(string jsonparams)
        {
            StringBuilder UserQuery = new StringBuilder();
            DataTable dt;
        ...
        [System.Web.Http.Route("api/GetFoliosF")]
        public JsonResult<List<ListFolio>> GetFoliosF(string jsonparams)
        {
            StringBuilder UserQuery = new StringBuilder();
            DataTable dt;
            dynamic data = JObject.Parse(jsonparams);
