...
namespace APIPOSS.Utilities
{
    ...
    public class Threads
    {
        ...
        public Threads(string emisor, string password, string mensaje, string asunto, string destinatario)
        {
            // Envio de Solo Email 
            this.emisor = emisor;
            this.password = password;
        ...
        //public Threads(string emisor, string password, string mensaje, string asunto, string destinatario, string Archivos)
        //{
        //    // Envio de Email y Adjunta Archivos evidencia de garantia
        //    this.emisor = emisor;
        //    this.password = password;
        //    this.mensaje = mensaje;
        //    this.asunto = asunto;
        ...
        public void SoloenviaCorreo()
        {
            try
            {

                enviarSoloCorreo(emisor, password, mensaje, asunto, destinatario);
        ...
        public void enviarSoloCorreo(string emisor, string password, string mensaje, string asunto, string destinatario)
        {
            try
            {
                correos.To.Clear();
